...
public class ScrollMechanic : MonoBehaviour, IDropHandler, IDragHandler, IBeginDragHandler, IPointerExitHandler, IPointerEnterHandler {
	...
	private void AddTestData()
	{
		...
		{
			GameObject obj = Instantiate(templatePrefab, content.transform);
			obj.SetActive(true);
		}
	}

	private void AddFirstPrefab()
	{
		if (firstPrefab != null)
		{
			GameObject obj = Instantiate(firstPrefab, content.transform);
			obj.SetActive(true);
			obj.transform.SetAsFirstSibling();
		}
	}

	private void AddLastPrefab()
	{
		if (lastPrefab != null)
		{
			GameObject obj = Instantiate(lastPrefab, content.transform);
			obj.SetActive(true);
